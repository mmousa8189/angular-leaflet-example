...
export class ShapeService {
  ...
  private egyptBoundaries =
    '/angular-leaflet-example/assets/data/egy_admbnda_adm0_capmas_itos_20170421.geojson';
  // egy_admbnda_adm1_capmas_20170421.geojson => for egypt states boundaries
  private egyptStatesBoundaries =
    '/angular-leaflet-example/assets/data/egy_admbnda_adm1_capmas_20170421.geojson';
  // egy_admbnda_adm1_capmas_20170421.geojson => for egypt states maraks boundaries
  private egyptMarakzBoundaries =
    '/angular-leaflet-example/assets/data/egy_admbnda_adm2_capmas_20170421.geojson';
  // egy_admbnda_adm1_capmas_20170421.geojson => for egypt states Cities boundaries
  private egyptCitiesBoundaries =
    '/angular-leaflet-example/assets/data/egy_admbnda_adm3_capmas_20170421.geojson';
  // egy_admbnda_adm1_capmas_20170421.geojson => for egypt Places Pins
  private egyptPlacesPins =
    '/angular-leaflet-example/assets/data/egy_admbndp_admall_capmas_itos_20170421.geojson';
  constructor(private http: HttpClient) {}

  getStateShapes() {
    return this.http.get(
      '/angular-leaflet-example/assets/data/gz_2010_us_040_00_5m.json'
    );
  }
